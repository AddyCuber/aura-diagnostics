...
const pricingPlans = [
  {
    ...
    features: ["5 resume analyses per month", "Basic job matching", "GitHub profile analysis", "Standard support"],
    popular: false,
    cta: "Get Started",
  },
  {
    ...
    monthlyPrice: 19,
    annualPrice: 15,
    description: "For serious job seekers and career growth",
    features: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
            Unlock your career potential with AI-powered resume analysis and job matching. Find your perfect opportunity today.
          </p>

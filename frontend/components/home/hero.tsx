          ...
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                Match <strong>candidates</strong> <span>&</span> <br />
                <strong>opportunities</strong> <em className="italic">intelligently</em>
              </h1>
            </motion.div>
            ...
            >
              Revolutionary AI-powered resume analysis platform that matches candidates with perfect job opportunities. Upload resumes, analyze GitHub profiles, and discover the ideal career fit with intelligent matching algorithms.
            </motion.p>

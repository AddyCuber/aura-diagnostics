...
const testimonials = [
  {
    name: "Arjun Mehta",
    username: "@arjdev",
    body: "This AI resume platform found me the perfect job match in just 2 weeks. The analysis was spot-on!",
    img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Sara Lin",
    username: "@sara.codes",
    body: "The GitHub integration revealed skills I didn't even know I had. Landed 3 interviews in one week!",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Devon Carter",
    username: "@devninja",
    body: "As a hiring manager, this platform helps me find the perfect candidates faster than ever before.",
    img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Priya Shah",
    username: "@priyacodes",
    body: "The AI analysis highlighted my strengths perfectly. Got my dream job at a top tech company!",
    img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Leo Martin",
    username: "@leobuilds",
    body: "Career transition made easy! The platform matched my transferable skills to new opportunities.",
    img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Chloe Winters",
    username: "@chloewinters",
    body: "Finally, a platform that understands my potential beyond just keywords. Game-changing technology!",
    img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Ayaan Malik",
    username: "@ayaan_dev",
    body: "The job matching accuracy is incredible. Every recommendation was relevant to my career goals.",
    img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Monica Reeves",
    username: "@monicareeves",
    body: "Our HR team saves hours with this platform. The candidate analysis is thorough and insightful.",
    img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "James Roy",
    username: "@jamesrdev",
    body: "From resume upload to job offer in 3 weeks. This platform revolutionized my job search!",
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-[540px]">
          ...
          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
            Discover how our AI-powered platform has transformed careers and revolutionized the hiring process for professionals worldwide.
          </p>
        </div>
